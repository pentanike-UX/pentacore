...
export function WorkPortfolioGlassRow({ row }: Props) {
  return (
    <Link
      ...
      scroll={row.href !== "#"}
      className={cn(
        "group isolate flex w-full flex-col items-start gap-6 rounded-[50px] px-6 py-8 outline-none transition-[transform,box-shadow] duration-300 ease-out md:flex-row md:items-center md:gap-[90px] md:px-10 md:py-10",
    ...
    >
      <div className="flex w-full shrink-0 items-center justify-start gap-[10px] md:w-[280px]">
        {row.logos.map((v) => (
      ...
      <div className="flex w-full shrink-0 flex-wrap items-center justify-start gap-2 md:w-[280px] md:justify-center lg:justify-end">
